...
const resources = {
	...
	district: [
		...
		{
			Parent: "district",
			Title: "District Board Meeting Packets",
			Type: "DROPDOWN",
			Description: "dbmp",
			URL: ""
		},
		{
			Parent: "district",
			Title: "District Board Meeting Minutes",
			Type: "DROPDOWN",
			Description: "dbmm",
			URL: ""
		},
	...
	kfam: [
		...
		{
			Parent: "kfam",
			Title: "ERF Supplemental Documents",
			Type: "DROPDOWN",
			Description: "erfsupp",
			URL: ""
		},
		{
			Parent: "kfam",
			Title: "Growing the Kiwanis Family Branches",
			Type: "DROPDOWN",
			Description: "growingkfam",
			URL: ""
		},
		{
			Parent: "kfam",
			Title: "Kiwanis Family Events",
			Type: "DROPDOWN",
			Description: "kfamevents",
			URL: ""
		},
	...
	mr: [
		{
			Parent: "mr",
			Title: "Master Record Sheet Files",
			Type: "DROPDOWN",
			Description: "mrs",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "District Convention 2021 Awards",
			Type: "DROPDOWN",
			Description: "dconawards",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "Distinguished Club Improvement Award",
			Type: "DROPDOWN",
		...
		{
			Parent: "mr",
			Title: "Distinguished Divisional Excellence Award",
			Type: "DROPDOWN",
		...
		{
			Parent: "mr",
			Title: "Distinguished Kiwanis Club",
			Type: "DROPDOWN",
			Description: "kiwanis",
			URL: ""
		},
		...
		{
			Parent: "mr",
			Title: "Don Hull Distinguished Kiwanis Family Relations Award",
			Type: "DROPDOWN",
			Description: "donhull",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "John Woodall Distinguished Membership Development and Education Award",
			Type: "DROPDOWN",
			Description: "JohnWoodall",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "Mei Po Wong Overall Service Award",
			Type: "DROPDOWN",
			Description: "MeiPoWong",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "New Member of the Year Award",
			Type: "DROPDOWN",
		...
		{
			Parent: "mr",
			Title: "Outstanding District Committee Member Award",
			Type: "DROPDOWN",
			Description: "districtcommittee",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "Outstanding Divisional Leadership Team Award",
			Type: "DROPDOWN",
			Description: "DLT",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "Outstanding Total Achievement",
			Type: "DROPDOWN",
		...
		{
			Parent: "mr",
			Title: "Returning General Member of the Year Award",
			Type: "DROPDOWN",
			Description: "genmember",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "Rich Thigpen Faculty Advisor of the Year",
			Type: "DROPDOWN",
			Description: "RichThigpen",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "Fall Training Conference 2021 Awards",
			Type: "DROPDOWN",
			Description: "ftcawards",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "Fall Training Conference 2020 Awards",
			Type: "DROPDOWN",
			Description: "ftcawards",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "2019-2020 Awards",
			Type: "DROPDOWN",
			Description: "pastawards1920",
			URL: ""
		},
		{
			Parent: "mr",
			Title: "2018-2019 Awards",
			Type: "DROPDOWN",
			Description: "pastawards1819",
			URL: ""
		},
	...
	dconawards: [
		...
		{
			Parent: "dconawards",
			Title: "Distinguished Appointed Board Member Award",
			Type: "DROPDOWN",
			Description: "aboard",
			URL: ""
		}
	...
	secretary: [
		...
		{
			Parent: "secretary",
			Title: "2020-2021 Club Event Report Form (CERF",
			Type: "DROPDOWN",
			Description: "",
			URL: ""
		},
		{
			Parent: "secretary",
			Title: "2020-2021 Monthly Report Form (MRF",
			Type: "DROPDOWN",
			Description: "",
			URL: ""
		},
